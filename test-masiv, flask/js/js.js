let question_arr = ["Яке море вважається найтеплішим у світі?","В якому з перерахованих озер тече не прісна, а солона вода?","Скільки відсотків поверхні Землі вкриті водним масивом?","Яка з країн володіє найменшою територією у всьому світі?","Яка пустеля вважається найбільш посушливою у світі?"]
let a1_arr = ["Азовське море","Озеро Ньяса","50%","Монако","Сахара"]
let a2_arr = ["Червоне море","Байкал","85%","Гондурас","Каракуми"]
let a3_arr = ["Аравійське море","Дон Жуан","64%","Ватикан","Атакама"]
let a4_arr = ["Мертве море","Світязь","70%","Люксембург","Пустеля Гобі"]
let answer_arr = ["Червоне море","Дон Жуан","70%","Ватикан","Атакама"]
